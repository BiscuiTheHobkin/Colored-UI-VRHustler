...
namespace Spoof_HWID
{
	...
	public class Plugin : VRModule
    {
        ...
        public static void Main()
        {
                ...
                GameObject.Find("MenuContent/Backdrop/Backdrop").gameObject.SetActive(false);
                ...
                GameObject.Find("LoadingBackground_TealGradient_Music/_FX_ParticleBubbles/FX_floor").gameObject.SetActive(true);
